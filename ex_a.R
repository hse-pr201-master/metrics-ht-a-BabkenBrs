...
# Изначально я предполагал, что температура и влажность будут влиять на зависимую переменную, причем температура положительно(потому что чем выше, тем легче будет происходит возгорание), а влажность отрицательно(чем более сухой воздух, тем сильнее горит вещество). Но мои предположения насчет температуры оказались ложными, потому что коэффициент получился отрицательным и незначимым. В случае с влажностью, коэффициент отрицательный, как я и предполагал, но, к сожалению, незначимый.
